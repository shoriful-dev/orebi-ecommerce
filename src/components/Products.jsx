    ...
    <Container>
      <div className="w-full px-4">
        <div className="relative group overflow-hidden border">
          <Image imgSrc={imgSrc} className="w-full h-auto md:w-[300px] md:h-[300px]"/>
          <Badge text={badgeText} className="absolute top-5 left-5" />
          <div className="w-full h-auto py-5 px-5 duration-500 absolute bottom-[-150px] left-0 bg-white opacity-80 invisible group-hover:visible space-y-5 group-hover:bottom-0">
        ...
        <div className="pt-5">
          <div className="flex justify-between">
            <Text as="p" text={text3} className="font-bold text-lg md:text-xl" />
            <Text as="p" text={text4} className="text-[#767676] text-sm md:text-base" />
          </div>
          <div className="pt-2">
            <Text as="p" text={text5} className="text-[#767676] text-sm md:text-base" />
          </div>
        </div>
      </div>
    </Container>
